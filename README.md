...
![Interactive cutscene — Wei Wuxian panicking while Lan Wangji stays cool, with dialogue reading "MN. WE REQUIRE YOUR ASSISTANCE." in a traditional palace setting](public_repo/interactive_cutscenes.png)
...
![Pick Your Weapon screen — four ornate pedestals displaying a fiery talisman, Maomao's hairpin, a purple BTS ARMY Bomb, and Frieren's glowing staff against a serene East Asian landscape](public_repo/pick_your_weapon.png)
...
![Rocky's Birthday Delivery gameplay — chibi characters, gift boxes, and a skull-marked coffin crate inside a festive spaceship with hearts, score, and high score on screen](public_repo/rockysdelivery_gameplay.png)
...
![Whack-A-Villain gameplay — chibi villain and hero heads popping from holes in a lantern-lit hall, with a silver hairpin cursor, hearts, and score displayed](public_repo/whack-a-villain_gameplay.png)
...
![Pause menu showing Music set to 8-bit, with Resume, Mute, and Quit to Menu options over the Whack-A-Villain gameplay](public_repo/options_for_music.png)
...
![Victory screen — "You Won!" in glowing gold and red text over a lantern-lit temple hall, with Keep Going, Play Again, and Return to Menu options](public_repo/win_state.png)
